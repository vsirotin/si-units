...
internal class CandelaTest {
    ...
    fun testCandelaYcdTest() {
        ...
        assertEquals(1.cd.Ycd , cd.value/myPow, ε)
        assertEquals(1.cd.yottacandela , cd.value/myPow, ε)
    ...
    fun testCandelaZcdTest() {
        ...
        assertEquals(1.cd.Zcd , cd.value/myPow, ε)
        assertEquals(1.cd.zettacandela , cd.value/myPow, ε)
    ...
    fun testCandelaEcdTest() {
        ...
        assertEquals(1.cd.Ecd , cd.value/myPow, ε)
        assertEquals(1.cd.exacandela , cd.value/myPow, ε)
    ...
    fun testCandelaPcdTest() {
        ...
        assertEquals(1.cd.Pcd , cd.value/myPow, ε)
        assertEquals(1.cd.petacandela , cd.value/myPow, ε)
    ...
    fun testCandelaTcdTest() {
        ...
        assertEquals(1.cd.Tcd , cd.value/myPow, ε)
        assertEquals(1.cd.teracandela , cd.value/myPow, ε)
    ...
    fun testCandelaGcdTest() {
        ...
        assertEquals(1.cd.Gcd , cd.value/myPow, ε)
        assertEquals(1.cd.gigacandela , cd.value/myPow, ε)
    ...
    fun testCandelaMcdTest() {
        ...
        assertEquals(1.cd.Mcd , cd.value/myPow, ε)
        assertEquals(1.cd.megacandela , cd.value/myPow, ε)
    ...
    fun testCandelaK1cdTest() {
        ...
        assertEquals(1.cd.kcd , cd.value/myPow, ε)
        assertEquals(1.cd.kilocandela , cd.value/myPow, ε)
    ...
    fun testCandelaH1cdTest() {
        ...
        assertEquals(1.cd.hcd , cd.value/myPow, ε)
        assertEquals(1.cd.hectocandela , cd.value/myPow, ε)
    ...
    fun testCandelaDA1cdTest() {
        ...
        assertEquals(1.cd.dacd , cd.value/myPow, ε)
        assertEquals(1.cd.decacandela , cd.value/myPow, ε)
    ...
    fun testCandelaD1cdTest() {
        ...
        assertEquals(1.cd.dcd , cd.value/myPow, ε)
        assertEquals(1.cd.decicandela , cd.value/myPow, ε)
    ...
    fun testCandelaC1cdTest() {
        ...
        assertEquals(1.cd.ccd , cd.value/myPow, ε)
        assertEquals(1.cd.centicandela , cd.value/myPow, ε)
    ...
    fun testCandelaM1cdTest() {
        ...
        assertEquals(1.cd.mcd , cd.value/myPow, ε)
        assertEquals(1.cd.millicandela , cd.value/myPow, ε)
        assertEquals(1.mcd , mcd)
    ...
    fun testCandelaΜ1cdTest() {
        ...
        assertEquals(1.cd.μcd , cd.value/myPow, ε)
        assertEquals(1.cd.microcandela , cd.value/myPow, ε)
    ...
    fun testCandelaN1cdTest() {
        ...
        assertEquals(1.cd.ncd , cd.value/myPow, ε)
        assertEquals(1.cd.nanocandela , cd.value/myPow, ε)
    ...
    fun testCandelaP1cdTest() {
        ...
        assertEquals(1.cd.pcd , cd.value/myPow, ε)
        assertEquals(1.cd.picocandela , cd.value/myPow, ε)
        assertEquals(1.pcd , pcd)
    ...
    fun testCandelaF1cdTest() {
        ...
        assertEquals(1.cd.fcd , cd.value/myPow, ε)
        assertEquals(1.cd.femtocandela , cd.value/myPow, ε)
    ...
    fun testCandelaA1cdTest() {
        ...
        assertEquals(1.cd.acd , cd.value/myPow, ε)
        assertEquals(1.cd.attocandela , cd.value/myPow, ε)
    ...
    fun testCandelaZ1cdTest() {
        ...
        assertEquals(1.cd.zcd , cd.value/myPow, ε)
        assertEquals(1.cd.zeptocandela , cd.value/myPow, ε)
        assertEquals(1.zcd , zcd)
    ...
    fun testCandelaY1cdTest() {
        ...
        assertEquals(1.cd.ycd , cd.value/myPow, ε)
        assertEquals(1.cd.yoctocandela , cd.value/myPow, ε)
        assertEquals(1.ycd , ycd)
