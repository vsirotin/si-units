...
internal class MetreTest {
    ...
    fun testMetreYmTest() {
        ...
        assertEquals(1.m.Ym , m.value/myPow, ε)
        assertEquals(1.m.yottametre , m.value/myPow, ε)
    ...
    fun testMetreZmTest() {
        ...
        assertEquals(1.m.Zm , m.value/myPow, ε)
        assertEquals(1.m.zettametre , m.value/myPow, ε)
    ...
    fun testMetreEmTest() {
        ...
        assertEquals(1.m.Em , m.value/myPow, ε)
        assertEquals(1.m.exametre , m.value/myPow, ε)
    ...
    fun testMetrePmTest() {
        ...
        assertEquals(1.m.Pm , m.value/myPow, ε)
        assertEquals(1.m.petametre , m.value/myPow, ε)
    ...
    fun testMetreTmTest() {
        ...
        assertEquals(1.m.Tm , m.value/myPow, ε)
        assertEquals(1.m.terametre , m.value/myPow, ε)
    ...
    fun testMetreGmTest() {
        ...
        assertEquals(1.m.Gm , m.value/myPow, ε)
        assertEquals(1.m.gigametre , m.value/myPow, ε)
    ...
    fun testMetreMmTest() {
        ...
        assertEquals(1.m.Mm , m.value/myPow, ε)
        assertEquals(1.m.megametre , m.value/myPow, ε)
    ...
    fun testMetreK1mTest() {
        ...
        assertEquals(1.m.km , m.value/myPow, ε)
        assertEquals(1.m.kilometre , m.value/myPow, ε)
    ...
    fun testMetreH1mTest() {
        ...
        assertEquals(1.m.hm , m.value/myPow, ε)
        assertEquals(1.m.hectometre , m.value/myPow, ε)
    ...
    fun testMetreDA1mTest() {
        ...
        assertEquals(1.m.dam , m.value/myPow, ε)
        assertEquals(1.m.decametre , m.value/myPow, ε)
    ...
    fun testMetreD1mTest() {
        ...
        assertEquals(1.m.dm , m.value/myPow, ε)
        assertEquals(1.m.decimetre , m.value/myPow, ε)
    ...
    fun testMetreC1mTest() {
        ...
        assertEquals(1.m.cm , m.value/myPow, ε)
        assertEquals(1.m.centimetre , m.value/myPow, ε)
    ...
    fun testMetreM1mTest() {
        ...
        assertEquals(1.m.mm , m.value/myPow, ε)
        assertEquals(1.m.millimetre , m.value/myPow, ε)
        assertEquals(1.mm , mm)
    ...
    fun testMetreΜ1mTest() {
        ...
        assertEquals(1.m.μm , m.value/myPow, ε)
        assertEquals(1.m.micrometre , m.value/myPow, ε)
    ...
    fun testMetreN1mTest() {
        ...
        assertEquals(1.m.nm , m.value/myPow, ε)
        assertEquals(1.m.nanometre , m.value/myPow, ε)
    ...
    fun testMetreP1mTest() {
        ...
        assertEquals(1.m.pm , m.value/myPow, ε)
        assertEquals(1.m.picometre , m.value/myPow, ε)
        assertEquals(1.pm , pm)
    ...
    fun testMetreF1mTest() {
        ...
        assertEquals(1.m.fm , m.value/myPow, ε)
        assertEquals(1.m.femtometre , m.value/myPow, ε)
    ...
    fun testMetreA1mTest() {
        ...
        assertEquals(1.m.am , m.value/myPow, ε)
        assertEquals(1.m.attometre , m.value/myPow, ε)
    ...
    fun testMetreZ1mTest() {
        ...
        assertEquals(1.m.zm , m.value/myPow, ε)
        assertEquals(1.m.zeptometre , m.value/myPow, ε)
        assertEquals(1.zm , zm)
    ...
    fun testMetreY1mTest() {
        ...
        assertEquals(1.m.ym , m.value/myPow, ε)
        assertEquals(1.m.yoctometre , m.value/myPow, ε)
        assertEquals(1.ym , ym)
