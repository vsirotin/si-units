...
private const val fileExtension = "ts"
fun generateSiUnitsTestBaseTsFiles() {
    //Generate package directory if not exists
    val dir = File("${ROOT_TS_TESTS}base")
    generatePackageMainFile(siUnitDescriptions, dir)
    generateClassFiles(dir, ::generateSiUnitTestBaseTsFiles)
}
...
private fun generatePackageMainFile(siUnitDescription: List<SiUnitDescription>, dir: File) {
    val fileName = "BaseTSTest.$fileExtension"
...
private fun generateSiUnitTestBaseTsFiles(siUnitDescription: SiUnitDescription, dir: File) {
