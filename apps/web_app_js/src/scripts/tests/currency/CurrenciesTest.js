...
import {checkObjects} from '/src/scripts/tests/checker.js';
 
const {sirotin: {kotunil: {currency: {UnitedStatesDollar, USD, Euro, EUR, JapaneseYen, JPY, PoundSterling, GBP, Renminbi, CNY, AustralianDollar, AUD, CanadianDollar, CAD, SwissFranc, CHF, HongKongDollar, HKD, SingaporeDollar, SGD, SwedishKrona, SEK, SouthKoreanWon, KRW, NorwegianKrone, NOK, NewZealandDollar, NZD, IndianRupee, INR, MexicanPeso, MXN, NewTaiwanDollar, TWD, SouthAfricanRand, ZAR, BrazilianReal, BRL, DanishKrone, DKK, PolishZłoty, PLN, ThaiBaht, THB, IsraeliNewShekel, ILS, IndonesianRupiah, IDR, CzechKoruna, CZK, UAEDirham, AED, TurkishLira, TRY, HungarianForint, HUF, ChileanPeso, CLP, SaudiRiyal, SAR, PhilippinePeso, PHP, MalaysianRinggit, MYR, ColombianPeso, COP, RussianRuble, RUB, RomanianLeu, RON}}}} = eu
